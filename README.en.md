...
|---|---|---|
| [`qwen-image-gen`](skills/qwen-image-gen/README.en.md) | Intent-preserving Qwen prompts, local edits, reference series, canvas adaptation and original-output review. [Guide and examples](docs/qwen-image-gen.md) · [Agent workflow](skills/qwen-image-gen/SKILL.md) | v0.1.0 experimental candidate |
