...
ROUTES = {"prompt", "edit", "series", "audit", "prepare", "no_trigger"}
...
def validate_data(data):
    ...
    require(data["skill"] == "qwen-image-gen", "skill mismatch")
...
def main():
    try:
        ...
        print(f"eval_schema=ok skill=qwen-image-gen cases={count}")
        return 0
