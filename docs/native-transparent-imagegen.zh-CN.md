...
有水印的第一版角色动作页作为本地身份与画材参考。权利人明确许可将通过技术 Alpha
门的[原始输出](../skills/native-transparent-imagegen/assets/tuanzi-hutao-native-alpha-example.png)
作为 Skill 展示图公开；角色、参考图和展示图保留全部权利，不进入 Apache-2.0 许可。
其余生成尝试不随仓库分发。
